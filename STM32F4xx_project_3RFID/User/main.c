...
unsigned int flag_RFID = 0;	/*Send SelectCard */	
unsigned int flag_RFID1=0; /* RFID1 active*/
unsigned int flag_RFID2=0;	/* RFID2 active*/
unsigned int flag_PC=0;		/* wait pc control*/
